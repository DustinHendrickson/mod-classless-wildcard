...
-- the groups are collapsed into one at the same time. A loot group picks a
-- single entry, and all of these carry Chance 100, so a satchel still hands
-- over exactly one set -- now any of them rather than the chassis's.
--
