...
-- ---------------------------------------------------------------------------
(990280, 4, 0, 'Chain of the Untethered', 6524, 3, 1, 200000, 40000, 2, -1, -1, 40, 35, 1,
 4, 12, 5, 12, 7, 10, 0, 0, 0, 0, 0, 2, 0, 0, 0,
 'Strength and intellect on one chain. Pick a side, or do not.', 12340),
(990281, 4, 0, 'Pendant of Split Purpose', 6522, 3, 1, 200000, 40000, 2, -1, -1, 40, 35, 1,
 3, 12, 45, 20, 7, 10, 0, 0, 0, 0, 0, 2, 0, 0, 0,
 'For the ones who stab and then heal the wound.', 12340),
(990282, 4, 0, 'Band of the Blurred Line', 9835, 3, 1, 180000, 36000, 11, -1, -1, 40, 35, 1,
 4, 10, 45, 18, 0, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0,
 'Strength and spellpower, welded into one ring.', 12340),
(990283, 4, 0, 'Loop of Contradiction', 9840, 3, 1, 180000, 36000, 11, -1, -1, 40, 35, 1,
...
-- ---------------------------------------------------------------------------
(990284, 4, 0, 'Codex of the Warpriest', 24039, 3, 1, 220000, 44000, 23, -1, -1, 40, 35, 1,
 4, 10, 45, 16, 7, 8, 0, 0, 0, 0, 0, 2, 0, 0, 0,
 'A tome braced to be swung if the reading goes badly.', 12340),
(990285, 4, 0, 'Grimoire of the Berserker', 23321, 3, 1, 220000, 44000, 23, -1, -1, 40, 35, 1,
 3, 12, 38, 24, 7, 10, 0, 0, 0, 0, 0, 2, 0, 0, 0,
 'An off-hand book carrying attack power. It has notes in the margins.', 12340),
(990286, 4, 6, 'Barrier of Raw Intellect', 18816, 3, 1, 250000, 50000, 14, -1, -1, 40, 35, 1,
...
(990293, 2, 16, 'Enchanted Bola', 38679, 3, 1, 150000, 30000, 25, -1, -1, 40, 35, 1,
...
-- ---------------------------------------------------------------------------
(990294, 4, 4, 'Legplates of the Windwalker', 25343, 3, 1, 280000, 56000, 7, -1, -1, 40, 35, 1,
 3, 20, 7, 14, 0, 0, 0, 0, 0, 0, 456, 2, 115, 6, 0,
 'Plate legs light enough to sprint in. Allegedly.', 12340),
(990295, 4, 1, 'Sabatons of the Silk Road', 33009, 3, 1, 220000, 44000, 8, -1, -1, 40, 35, 1,
